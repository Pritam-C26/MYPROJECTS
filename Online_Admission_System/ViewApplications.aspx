<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewApplications.aspx.cs" Inherits="Online_Admission_System.ViewApplications" %>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <asp:GridView ID="GridView1" runat="server" 
                                CssClass="table table-bordered table-striped" OnRowCommand="GridView1_RowCommand"
                                    ...
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                            <asp:Button ID="btnView" runat="server" Text="View"
                                                CssClass="btn btn-sm btn-info me-1" CommandArgument='<%#Eval("ApplicationId") %>'
                                                CommandName="ViewDetails" />
                                            <asp:Button ID="btnApprove" runat="server" Text="Approve"
                                                CssClass="btn btn-sm btn-success me-1"
                                                CommandArgument='<%#Eval("ApplicationId") %>' CommandName="Approve" />
                                            <asp:Button ID="btnReject" runat="server" Text="Reject"
                                                CssClass="btn btn-sm btn-danger"
                                                CommandArgument='<%#Eval("ApplicationId") %>'  CommandName="Reject"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
