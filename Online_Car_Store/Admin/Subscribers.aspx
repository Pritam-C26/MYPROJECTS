<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Subscribers.aspx.cs" Inherits="Online_Car_Store.Admin.Subscribers" %>
...
<head runat="server">
    ...
    <title>Wheelz Admin Panel - Subscribers</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="sidebar d-flex flex-column p-3">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="Subscribers.aspx" class="nav-link active"><i class="bi bi-people"></i> Subscribers</a>
                </li>
                <li>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <asp:GridView ID="gvSubscribers" runat="server" CssClass="table table-bordered table-striped table-hover"
                    AutoGenerateColumns="False" AllowPaging="true" PageSize="10">
                    <Columns>
                        <asp:BoundField DataField="SubscribeId" HeaderText="ID" />
                        <asp:BoundField DataField="Subscribemail" HeaderText="Email" />
                        <asp:BoundField DataField="SubscribeDate" HeaderText="Subscribed On" DataFormatString="{0:dd-MMM-yyyy}" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
